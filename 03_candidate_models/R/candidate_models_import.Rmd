...
This file analyzes data from optimization of the 2 equation sFLT1 DDE model to the Jung and Hornig time course datasets. These data will be analyzed using the script "sFlt-model/analysis-R/draft/03_candidate_models/candidate_opt_workspace.Rmd".
