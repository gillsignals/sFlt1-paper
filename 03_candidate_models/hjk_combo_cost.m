function cost = hjk_combo_cost(k_try, kinghorn_T_exp, kinghorn_X_exp, kinghorn_I_exp, ...
    jung_T_exp, jung_X_exp, jung_I_exp, hornig_T_exp, hornig_X_exp, prod_case, mat_case, ...
    internalize_case, sp, p, param_names, conv_factor, pulse_length, chase_length,  ...
    hornig_secr_end_time, time_interval, jung_cost_option, hornig_cost_option, ...
    kinghorn_cost_option, outdir, status_message)
...
% hjk_combo_cost  Cost function to optimize trafficking parameters 
%               to simultaneously fit Jung et al., 2012 pulse-chase data 
%               and one Hornig et al., 2000 dataset within lsqnonlin
%               using specified set of equations
%
...
%       jung_v2.lysate, hornig.basal_time, hornig.basal_Sx_ng_ml, prod_case, sp, p,
%       param_names, conv_factor_ngml, pulse_length, chase_length, 
%       hornig_secr_end_time, time_interval, cost_option, eqn_case, outdir, status_message);
%
%
        ...
        for j=3:length(hornig_T_exp)   % removing early concs potentially below detection limit
            ...
            switch hornig_cost_option
                ...
                case 'absolute_omit3h'
                    ...
                    hornig_X_cost(j-2) = constitutive_sim_Y(sp.X, t_index) - hornig_X_exp(j);
