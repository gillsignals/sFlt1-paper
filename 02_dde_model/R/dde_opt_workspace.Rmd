...
This file analyzes data from optimization of the 2 equation sFLT1 DDE model to the pulse-chase and constitutive time course datasets. These data were imported using the script "02_dde_model/R/dde_opt_import.Rmd" and processed with "02_dde_model/R/dde_opt_preprocessing.Rmd".
