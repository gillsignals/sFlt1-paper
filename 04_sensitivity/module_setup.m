...
% jh_opt_median_230307: Jung-Hornig simultaneous optimization
% hjk_opt_median_230821: Hornig-Jung-Kinghorn simultaneous optimization
...
% specify equation case: base DDE
mat_delay = ["yes"];
internalize_case = ["no"];
