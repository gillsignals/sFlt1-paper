...
This file analyzes data from optimization of the 2 equation sFLT1 ODE model to 1 pulse-chase and 2 constitutive secretion (Kinghorn, Hornig) time course datasets. These data will be analyzed using the script "sFlt-model/analysis-R/draft/01_ode_model/ode_opt_workspace_2023-08-14.Rmd".

The optimization was performed 8/14/23 using the Matlab script "sFlt-model/01_ode_model/ode_driver.m" with following options: 
