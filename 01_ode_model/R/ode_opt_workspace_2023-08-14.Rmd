...
This file analyzes data from optimization of the 2 equation sFLT1 ODE model to 1 pulse-chase and 2 constitutive secretion (Kinghorn, Hornig) time course datasets. These data were imported using the script "sFlt-model/analysis-R/draft/01_ode_model/ode_hjk_opt_import.Rmd".
